...
# Inside container, HF cache is at /root/.cache/huggingface (symlinks require full cache mount)
HF_MODEL_PATH_CONTAINER="/root/.cache/huggingface/hub/models--KRAFTON--Raon-SpeechChat-9B/snapshots/d844aee2c3da129b92fce3e0193c07eb98b88443"
...
if [ ! -d "${EXPORT_DIR}/text_model" ]; then
    ...
    docker run --rm \
        ...
        python -m raon.export \
            --input_path "${HF_MODEL_PATH_CONTAINER}" \
